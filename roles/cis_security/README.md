...
Requires Ansible 3 or ansible-core 2.11 or better due to runtime.yml being set up for Automation Hub.
...
- 7/24/2022 - dsglaser@gmail.com - Conversion to full collection status (Namespace: dsglaser)