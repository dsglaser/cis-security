...
|  RHEL 8 / Fedora 31  |  RHEL 7   |  Ubuntu 18.04 | Control Description |
| -----------------|--------------------- | -----------------|--------------------- |
...
|  2.2.14   |  2.2.6    |  2.2.6        |   Remove LDAP server (skipped in RHEL 8)
...
|  5.2.2    |  5.2.14   |  5.2.18       |   Ensure SSH access is limited (skipping: environment dependent)
...
|  6.2.9-13,|0 6.2.10-14|  6.2.10-14    |   Various controls recommended to be run by monitoring software
